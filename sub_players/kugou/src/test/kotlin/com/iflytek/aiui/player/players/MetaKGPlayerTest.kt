...
import com.iflytek.aiui.player.common.player.MediaPlayerInitializer
...
class MetaKGPlayerTest {
    ...
    @InjectMocks
    private val player = MetaKGPlayer(context, mRPC, storage)
    ...
    fun play() {
        ...
        player.play(MetaItem(JSONObject(hashMapOf<String,Any>(
                "source" to "kugou",
                "itemid" to itemID
        )), "story"))
