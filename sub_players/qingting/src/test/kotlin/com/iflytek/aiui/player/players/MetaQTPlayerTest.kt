...
class MetaQTPlayerTest {
    ...
    @InjectMocks
    private val player: MetaQTPlayer = MetaQTPlayer(MockContext(), mock(), mock())

    private val validItem = MetaItem(JSONObject(hashMapOf<String, Any>(
    ...
    @Test
    fun canDispose() {
        assertTrue(player.canDispose(MetaItem(JSONObject(hashMapOf<String,Any>(
                "source" to "qingtingfm",
        ...
        assertFalse(player.canDispose(MetaItem(JSONObject(hashMapOf<String,Any>(
                "source" to "qingtingfm",
    ...
    fun playProgram() {
        val channelId = 123
        val programId = 456
        val item = MetaItem(JSONObject(hashMapOf<String,Any>(
                "source" to "qingtingfm",
