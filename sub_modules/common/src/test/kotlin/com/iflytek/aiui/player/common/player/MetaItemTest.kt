...
class MetaItemTest {
    ...
    fun parse() {
        ...
        val storyItem = MetaItem(JSONObject(hashMapOf<String, Any>(
                "name" to storyName,
                "playUrl" to storyUrl
        )), "story")
        ...
        val jokeItem = MetaItem(JSONObject(hashMapOf<String, Any>(
                "title" to jokeName,
                "mp3Url" to jokeUrl
        )), "joke")
        ...
        val radioItem = MetaItem(JSONObject(hashMapOf<String, Any>(
                "name" to radioName,
                "url" to radioUrl
        )), "radio")
    ...
    @Test
    fun equals() {
        val info = JSONObject(hashMapOf<String, Any>(
                "name" to "foo",
        ...
        val radioItem =JSONObject(hashMapOf<String, Any>(
                "name" to "广播",
